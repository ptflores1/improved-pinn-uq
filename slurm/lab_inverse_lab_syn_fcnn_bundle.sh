...
#SBATCH --output=logs/lab_inverse_lab_syn_fcnn_bundle.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/lab_inverse_lab_syn_fcnn_bundle.log          # Output de errores (opcional)
...
python3 main.py lab fcnn -b   -ids=lab_syn  -i=2
