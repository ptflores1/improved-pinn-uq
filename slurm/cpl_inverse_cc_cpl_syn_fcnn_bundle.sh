...
#SBATCH --output=logs/cpl_inverse_cc_cpl_syn_fcnn_bundle.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/cpl_inverse_cc_cpl_syn_fcnn_bundle.log          # Output de errores (opcional)
...
python3 main.py cpl fcnn -b   -ids=cc_cpl_syn  -i=2
