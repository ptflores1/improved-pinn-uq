#!/bin/bash
#SBATCH --job-name=plot_eq_lcdm          # Nombre del trabajo
#SBATCH --chdir=/home/ptflores1/storage/UAI
#SBATCH --output=logs/plot_eq_lcdm.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/plot_eq_lcdm.log          # Output de errores (opcional)
