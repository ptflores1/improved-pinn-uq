...
#SBATCH --output=logs/hs_inverse_cc_bbb_ov_bundle.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/hs_inverse_cc_bbb_ov_bundle.log          # Output de errores (opcional)
...
python3 main.py hs bbb -b  -ov -ids=cc  -i=2 -bm=clfcnn
