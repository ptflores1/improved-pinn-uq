...
#SBATCH --output=logs/cpl_hmc_ov_gpu.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/cpl_hmc_ov_gpu.log          # Output de errores (opcional)
