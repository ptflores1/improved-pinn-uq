...
#SBATCH --output=logs/quintessence_inverse_cc_hmc_res_bundle.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/quintessence_inverse_cc_hmc_res_bundle.log          # Output de errores (opcional)
...
python3 main.py quintessence hmc -b   -ids=cc -rl -i=2
