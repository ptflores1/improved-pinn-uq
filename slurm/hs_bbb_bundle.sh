...
#SBATCH --output=logs/hs_bbb_bundle.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/hs_bbb_bundle.log          # Output de errores (opcional)
