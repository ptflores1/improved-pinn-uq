...
#SBATCH --output=logs/lcdm_hmc_res_bundle.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/lcdm_hmc_res_bundle.log          # Output de errores (opcional)
