...
#SBATCH --output=logs/hs_inverse_cc_hmc_bundle.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/hs_inverse_cc_hmc_bundle.log          # Output de errores (opcional)
...
python3 main.py hs hmc -b   -ids=cc  -i=2 -bm=clfcnn
