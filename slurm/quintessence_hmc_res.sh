...
#SBATCH --output=logs/quintessence_hmc_res.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/quintessence_hmc_res.log          # Output de errores (opcional)
