#!/bin/bash
#SBATCH --job-name=plot_data_hs__-b          # Nombre del trabajo
#SBATCH --chdir=/home/ptflores1/storage/UAI
#SBATCH --output=logs/plot_data_hs__-b_train.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/plot_data_hs__-b_train.log          # Output de errores (opcional)
...
python3 -m plotters.main hs  -b  --domain_type=train
