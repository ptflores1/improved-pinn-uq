...
#SBATCH --output=logs/hs_clfcnn_bundle_gpu.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/hs_clfcnn_bundle_gpu.log          # Output de errores (opcional)
...
python3 main.py hs clfcnn -b     --gpu -bm=clfcnn
