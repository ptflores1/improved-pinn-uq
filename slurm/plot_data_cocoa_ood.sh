...
#SBATCH --output=logs/plot_data_cocoa___ood.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/plot_data_cocoa___ood.log          # Output de errores (opcional)
...
python3 -m plotters.main cocoa    --domain_type=ood
