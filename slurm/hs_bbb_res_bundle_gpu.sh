#!/bin/bash
#SBATCH --job-name=hs_bundle          # Nombre del trabajo
#SBATCH --chdir=/home/ptflores1/storage/UAI
#SBATCH --output=logs/hs_bbb_res_bundle_gpu.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/hs_bbb_res_bundle_gpu.log          # Output de errores (opcional)
...
python3 main.py hs bbb -b    -rl --gpu -bm=clfcnn
