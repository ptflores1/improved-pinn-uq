#!/bin/bash
#SBATCH --job-name=plot_eq_quintessence          # Nombre del trabajo
#SBATCH --chdir=/home/ptflores1/storage/UAI
#SBATCH --output=logs/plot_eq_quintessence.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/plot_eq_quintessence.log          # Output de errores (opcional)
...
python3 -m plotters.quintessence
