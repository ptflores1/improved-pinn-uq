...
#SBATCH --output=logs/lab_bbb_ov_gpu.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/lab_bbb_ov_gpu.log          # Output de errores (opcional)
