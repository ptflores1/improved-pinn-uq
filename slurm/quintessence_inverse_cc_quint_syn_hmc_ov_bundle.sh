...
#SBATCH --output=logs/quintessence_inverse_cc_quint_syn_hmc_ov_bundle.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/quintessence_inverse_cc_quint_syn_hmc_ov_bundle.log          # Output de errores (opcional)
...
python3 main.py quintessence hmc -b  -ov -ids=cc_quint_syn  -i=2
