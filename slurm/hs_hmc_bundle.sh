...
#SBATCH --output=logs/hs_hmc_bundle.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/hs_hmc_bundle.log          # Output de errores (opcional)
