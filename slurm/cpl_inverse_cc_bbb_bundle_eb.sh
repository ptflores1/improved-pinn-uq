...
#SBATCH --output=logs/cpl_inverse_cc_bbb_bundle_eb.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/cpl_inverse_cc_bbb_bundle_eb.log          # Output de errores (opcional)
...
python3 main.py cpl bbb -b -eb  -ids=cc  -i=2
