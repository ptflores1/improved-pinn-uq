...
#SBATCH --output=logs/lab_hmc_ov_bundle.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/lab_hmc_ov_bundle.log          # Output de errores (opcional)
