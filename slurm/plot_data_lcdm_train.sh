#!/bin/bash
#SBATCH --job-name=plot_data_lcdm__          # Nombre del trabajo
#SBATCH --chdir=/home/ptflores1/storage/UAI
#SBATCH --output=logs/plot_data_lcdm___train.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/plot_data_lcdm___train.log          # Output de errores (opcional)
...
python3 -m plotters.main lcdm    --domain_type=train
