...
#SBATCH --output=logs/cpl_hmc_bundle.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/cpl_hmc_bundle.log          # Output de errores (opcional)
