...
#SBATCH --output=logs/lcdm_inverse_cc_hmc_bundle.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/lcdm_inverse_cc_hmc_bundle.log          # Output de errores (opcional)
...
python3 main.py lcdm hmc -b   -ids=cc  -i=2
