...
#SBATCH --output=logs/hs_inverse_cc_hs_syn_fcnn_bundle.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/hs_inverse_cc_hs_syn_fcnn_bundle.log          # Output de errores (opcional)
...
python3 main.py hs fcnn -b   -ids=cc_hs_syn  -i=2 -bm=clfcnn
