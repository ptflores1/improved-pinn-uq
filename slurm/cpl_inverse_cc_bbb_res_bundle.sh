...
#SBATCH --output=logs/cpl_inverse_cc_bbb_res_bundle.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/cpl_inverse_cc_bbb_res_bundle.log          # Output de errores (opcional)
...
python3 main.py cpl bbb -b   -ids=cc -rl -i=2
