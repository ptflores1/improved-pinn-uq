#!/bin/bash
#SBATCH --job-name=plot_eq_hs          # Nombre del trabajo
#SBATCH --chdir=/home/ptflores1/storage/UAI
#SBATCH --output=logs/plot_eq_hs.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/plot_eq_hs.log          # Output de errores (opcional)
