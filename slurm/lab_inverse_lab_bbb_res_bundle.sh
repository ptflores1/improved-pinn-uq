...
#SBATCH --output=logs/lab_inverse_lab_bbb_res_bundle.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/lab_inverse_lab_bbb_res_bundle.log          # Output de errores (opcional)
...
python3 main.py lab bbb -b   -ids=lab -rl -i=2
