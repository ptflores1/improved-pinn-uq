...
#SBATCH --output=logs/quintessence_inverse_cc_quint_syn_bbb_ov_bundle.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/quintessence_inverse_cc_quint_syn_bbb_ov_bundle.log          # Output de errores (opcional)
...
python3 main.py quintessence bbb -b  -ov -ids=cc_quint_syn  -i=2
