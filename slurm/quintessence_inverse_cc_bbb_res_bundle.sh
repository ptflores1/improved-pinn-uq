...
#SBATCH --output=logs/quintessence_inverse_cc_bbb_res_bundle.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/quintessence_inverse_cc_bbb_res_bundle.log          # Output de errores (opcional)
...
python3 main.py quintessence bbb -b   -ids=cc -rl -i=2
