#!/bin/bash
#SBATCH --job-name=quintessence_bundle          # Nombre del trabajo
#SBATCH --chdir=/home/ptflores1/storage/UAI
#SBATCH --output=logs/quintessence_bbb_res_bundle_gpu.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/quintessence_bbb_res_bundle_gpu.log          # Output de errores (opcional)
...
python3 main.py quintessence bbb -b    -rl --gpu
