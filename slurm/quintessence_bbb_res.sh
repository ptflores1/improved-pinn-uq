...
#SBATCH --output=logs/quintessence_bbb_res.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/quintessence_bbb_res.log          # Output de errores (opcional)
