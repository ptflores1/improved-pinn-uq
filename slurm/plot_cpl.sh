#!/bin/bash
#SBATCH --job-name=plot_eq_cpl          # Nombre del trabajo
#SBATCH --chdir=/home/ptflores1/storage/UAI
#SBATCH --output=logs/plot_eq_cpl.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/plot_eq_cpl.log          # Output de errores (opcional)
