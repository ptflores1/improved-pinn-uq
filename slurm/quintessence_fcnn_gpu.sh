...
#SBATCH --output=logs/quintessence_fcnn_gpu.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/quintessence_fcnn_gpu.log          # Output de errores (opcional)
...
python3 main.py quintessence fcnn     
