#!/bin/bash
#SBATCH --job-name=lab_bundle          # Nombre del trabajo
#SBATCH --chdir=/home/ptflores1/storage/UAI
#SBATCH --output=logs/lab_bbb_res_bundle_gpu.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/lab_bbb_res_bundle_gpu.log          # Output de errores (opcional)
...
python3 main.py lab bbb -b    -rl --gpu
