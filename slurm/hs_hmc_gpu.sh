...
#SBATCH --output=logs/hs_hmc_gpu.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/hs_hmc_gpu.log          # Output de errores (opcional)
...
python3 main.py hs hmc      -bm=clfcnn
