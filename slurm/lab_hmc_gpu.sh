...
#SBATCH --output=logs/lab_hmc_gpu.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/lab_hmc_gpu.log          # Output de errores (opcional)
