...
#SBATCH --output=logs/cpl_inverse_cc_cpl_syn_hmc_bundle_eb.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/cpl_inverse_cc_cpl_syn_hmc_bundle_eb.log          # Output de errores (opcional)
...
python3 main.py cpl hmc -b -eb  -ids=cc_cpl_syn  -i=2
