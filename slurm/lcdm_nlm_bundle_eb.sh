...
#SBATCH --output=logs/lcdm_nlm_bundle_eb.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/lcdm_nlm_bundle_eb.log          # Output de errores (opcional)
