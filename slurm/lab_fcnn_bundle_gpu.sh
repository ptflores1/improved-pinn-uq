...
#SBATCH --output=logs/lab_fcnn_bundle_gpu.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/lab_fcnn_bundle_gpu.log          # Output de errores (opcional)
...
python3 main.py lab fcnn -b     --gpu
