#!/bin/bash
#SBATCH --job-name=cpl          # Nombre del trabajo
#SBATCH --chdir=/home/ptflores1/storage/UAI
#SBATCH --output=logs/cpl_hmc_res_gpu.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/cpl_hmc_res_gpu.log          # Output de errores (opcional)
