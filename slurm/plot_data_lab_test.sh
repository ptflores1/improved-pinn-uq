...
#SBATCH --output=logs/plot_data_lab___test.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/plot_data_lab___test.log          # Output de errores (opcional)
...
python3 -m plotters.main lab    --domain_type=test
