...
#SBATCH --output=logs/cpl_bbb_ov_bundle_gpu.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/cpl_bbb_ov_bundle_gpu.log          # Output de errores (opcional)
...
python3 main.py cpl bbb -b  -ov   --gpu
