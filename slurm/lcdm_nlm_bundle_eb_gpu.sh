...
#SBATCH --output=logs/lcdm_nlm_bundle_eb_gpu.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/lcdm_nlm_bundle_eb_gpu.log          # Output de errores (opcional)
