#!/bin/bash
#SBATCH --job-name=plot_eq_mixed_equations          # Nombre del trabajo
#SBATCH --chdir=/home/ptflores1/storage/UAI
#SBATCH --output=logs/plot_eq_mixed_equations.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/plot_eq_mixed_equations.log          # Output de errores (opcional)
...
python3 -m plotters.mixed_equations
