...
#SBATCH --output=logs/hs_clfcnn_gpu.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/hs_clfcnn_gpu.log          # Output de errores (opcional)
