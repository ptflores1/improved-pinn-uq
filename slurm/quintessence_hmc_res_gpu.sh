#!/bin/bash
#SBATCH --job-name=quintessence          # Nombre del trabajo
#SBATCH --chdir=/home/ptflores1/storage/UAI
#SBATCH --output=logs/quintessence_hmc_res_gpu.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/quintessence_hmc_res_gpu.log          # Output de errores (opcional)
...
python3 main.py quintessence hmc     -rl
