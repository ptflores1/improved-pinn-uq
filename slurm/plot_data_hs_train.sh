#!/bin/bash
#SBATCH --job-name=plot_data_hs__          # Nombre del trabajo
#SBATCH --chdir=/home/ptflores1/storage/UAI
#SBATCH --output=logs/plot_data_hs___train.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/plot_data_hs___train.log          # Output de errores (opcional)
...
python3 -m plotters.main hs    --domain_type=train
