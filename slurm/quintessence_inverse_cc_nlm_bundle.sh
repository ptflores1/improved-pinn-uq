...
#SBATCH --output=logs/quintessence_inverse_cc_nlm_bundle.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/quintessence_inverse_cc_nlm_bundle.log          # Output de errores (opcional)
...
python3 main.py quintessence nlm -b   -ids=cc  -i=2
