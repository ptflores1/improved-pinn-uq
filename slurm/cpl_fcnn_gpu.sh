...
#SBATCH --output=logs/cpl_fcnn_gpu.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/cpl_fcnn_gpu.log          # Output de errores (opcional)
