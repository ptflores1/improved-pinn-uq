...
#SBATCH --output=logs/plot_data_hs__-b_ood.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/plot_data_hs__-b_ood.log          # Output de errores (opcional)
...
python3 -m plotters.main hs  -b  --domain_type=ood
