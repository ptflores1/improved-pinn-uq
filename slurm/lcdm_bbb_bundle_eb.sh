...
#SBATCH --output=logs/lcdm_bbb_bundle_eb.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/lcdm_bbb_bundle_eb.log          # Output de errores (opcional)
