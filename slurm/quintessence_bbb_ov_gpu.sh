...
#SBATCH --output=logs/quintessence_bbb_ov_gpu.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/quintessence_bbb_ov_gpu.log          # Output de errores (opcional)
...
python3 main.py quintessence bbb   -ov  
