#!/bin/bash
#SBATCH --job-name=plot_data_cpl_best_fit          # Nombre del trabajo
#SBATCH --chdir=/home/ptflores1/storage/UAI
#SBATCH --output=logs/plot_data_cpl_best_fit.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/plot_data_cpl_best_fit.log          # Output de errores (opcional)
...
python3 -m plotters.main cpl   -bf --domain_type=
