...
#SBATCH --output=logs/plot_data_cpl_-eb__ood.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/plot_data_cpl_-eb__ood.log          # Output de errores (opcional)
...
python3 -m plotters.main cpl -eb   --domain_type=ood
