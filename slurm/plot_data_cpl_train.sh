#!/bin/bash
#SBATCH --job-name=plot_data_cpl__          # Nombre del trabajo
#SBATCH --chdir=/home/ptflores1/storage/UAI
#SBATCH --output=logs/plot_data_cpl___train.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/plot_data_cpl___train.log          # Output de errores (opcional)
...
python3 -m plotters.main cpl    --domain_type=train
