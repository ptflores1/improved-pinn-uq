#!/bin/bash
#SBATCH --job-name=metrics          # Nombre del trabajo
#SBATCH --chdir=/home/ptflores1/storage/UAI
#SBATCH --output=logs/metrics.log         # Nombre del output (%j se reemplaza por el ID del trabajo)
#SBATCH --error=logs/metrics.log          # Output de errores (opcional)
